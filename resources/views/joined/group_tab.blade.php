<div style="overflow: scroll;border-radius: 5px;margin: 5px; padding-top:20px;padding-left:30px;padding-right:30px;padding-bottom:30px;box-shadow: 0px 2px 7px #bbbbbb; background-color: white;">
    @if($current_group)
        <div class="container">
            <div class="row">
                <h3>{{$group_name}}</h3>
