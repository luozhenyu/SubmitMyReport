    ...
    @if($group)
        <div class="container">
            ...
            <div class="row" style="margin-top: 20px;">
                @if ($user->is_creator)
                    <a href="/group/destroy?group_id={{$group->id}}" class="btn btn-danger btn-lg" role="button" style="width:100%;">Delete Group</a>
                @else
                    <a href="/group/resign?group_id={{$group->id}}" class="btn btn-danger btn-lg" role="button" style="width:100%;">Resign</a>
                @endif
