...
<div class="container" style="height: 100%;">
    <div class="row align-items-center" style="height: 100%">
        <div class="col col-sm-12 offset-sm-0 col-md-4 offset-md-4"
             style="border-radius: 5px; box-shadow: 0px 2px 7px #bbbbbb; background-color: white; padding: 0px;">
            <div class="bg-primary text-center"
                 style="border-radius: 5px; padding-top: 20px; padding-bottom: 15px; box-shadow: 0px 2px 7px #bbbbbb;">
